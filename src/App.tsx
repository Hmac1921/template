    ...
    <main className="min-h-screen bg-[--surface-muted] px-5 py-10 text-[--ink]">
      <div className="mx-auto grid max-w-6xl gap-8">
        <section className="app-hero">
          <div>
            <p className="app-eyebrow">Dialog molecule</p>
            <h1>Three ways to open the same polished conversation layer.</h1>
          </div>
          <p className="app-intro">
            Centered over the screen, snapped over its parent, or pushed into the
            parent space as an inline replacement.
          </p>
        </section>

        <section className="grid gap-5 lg:grid-cols-3">
          <article className="surface-gradient rounded-[--radius-lg] border border-[--border] bg-[--surface] p-5 shadow-[--shadow-card]">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[--brand]">
              Screen overlay
            </p>
          ...
          <ParentDialog
            ...
            open={parentOpen}
            parent={
              <article className="min-h-[24rem] rounded-[--radius-lg] border border-[--border] bg-[--surface] p-5 shadow-[--shadow-card]">
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[--brand]">
                  Parent overlay
                </p>
                <h2 className="mt-2 font-display text-2xl font-semibold">
                ...
                <p className="mt-3 text-sm leading-6 text-[--ink-muted]">
                  ...
                  dialog floats inside its bounds.
                </p>
                <div className="mt-5 grid gap-3 rounded-[--radius-md] bg-[--surface-muted] p-4 text-sm text-[--ink-muted]">
